...
(function ($) {
    ...
    skel.init({
        ...
        breakpoints: {
            global: {
                range: '*',
                href: 'http://localhost/marriage/assets/css/horizons/style.css',
                containers: 1400,
                grid: {gutters: 50}
            },
            wide: {
                range: '-1680',
                href: 'http://localhost/marriage/assets/css/horizons/style-wide.css',
                containers: 1200,
                grid: {gutters: 40}
            },
            normal: {
                range: '-1280',
                href: 'http://localhost/marriage/assets/css/horizons/style-normal.css',
                containers: 960,
                lockViewport: true
            },
            narrow: {
                range: '-980',
                href: 'http://localhost/marriage/assets/css/horizons/style-narrow.css',
                containers: '95%',
                grid: {gutters: 30}
            },
            narrower: {
                range: '-840',
                href: 'http://localhost/marriage/assets/css/horizons/style-narrower.css',
                grid: {collapse: 1}
            },
            mobile: {
                range: '-640',
                href: 'http://localhost/marriage/assets/css/horizons/style-mobile.css',
                containers: '90%',
